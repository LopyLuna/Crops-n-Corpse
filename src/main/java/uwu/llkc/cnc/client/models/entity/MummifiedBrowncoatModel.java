...
public class MummifiedBrowncoatModel<E extends MummifiedBrowncoat> extends HierarchicalModel<E> implements HeadedModel, ArmedModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, 0, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12, 0.0F));

        PartDefinition Tie = root.addOrReplaceChild("tie", CubeListBuilder.create().texOffs(32, 32).addBox(-2, -0, 0, 4.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -2.1F));

        PartDefinition RightArm = root.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(40, 32).addBox(-3, -2.0F, 2, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -2.0F, 0.0F, -1.309F, 0.0F, 0.0F));

        PartDefinition LeftArm = root.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(16, 32).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition Forearm = LeftArm.addOrReplaceChild("left_forearm", CubeListBuilder.create().texOffs(16, 42).addBox(-3.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 4.0F, 0.0F));

        PartDefinition RightLeg = root.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2, 12, 0));

        PartDefinition LeftLeg = root.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 32).addBox(-2, 0, -2, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2, 12, 0.0F));
    ...
    private static class HumanoidBrowncoat extends HumanoidModel<MummifiedBrowncoat> {
