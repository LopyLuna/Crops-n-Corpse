...
public class SnowPeaModel extends HierarchicalModel<SnowPea> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition LeafSouth = Leaves.addOrReplaceChild("LeafSouth", CubeListBuilder.create().texOffs(17, 24).addBox(-2.5F, -1.0F, 0.0F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5F, 1.0F, 0.2618F, 0.0F, 0.0F));

        PartDefinition LeafNorth = Leaves.addOrReplaceChild("LeafNorth", CubeListBuilder.create().texOffs(0, 21).addBox(-2.5F, -1.0F, -6.0F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5F, -1.0F, -0.2618F, 0.0F, 0.0F));
        ...
        PartDefinition Head = rootHead.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 1).addBox(-2.5F, -5.0F, -3.0F, 5.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0, 0, 0.1745F, 0.0F, 0.0F));

        PartDefinition Spikes = Head.addOrReplaceChild("Spikes", CubeListBuilder.create().texOffs(0, 38).addBox(-1.5F, -1.5F, -1.0F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.5F, 2.5F, 0.2618F, 0.0F, 0.0F));

        PartDefinition OuterSpikes = Spikes.addOrReplaceChild("OuterSpikes", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -0.0884F, -1.0242F, 0.0F, 0.0F, -0.7854F));

        PartDefinition bottom_r1 = OuterSpikes.addOrReplaceChild("bottom_r1", CubeListBuilder.create().texOffs(21, 34).addBox(-1.0F, -1.5F, -1.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.5884F, 1.0242F, -0.7854F, 0.0F, 0.0F));

        PartDefinition right_r1 = OuterSpikes.addOrReplaceChild("right_r1", CubeListBuilder.create().texOffs(30, 37).addBox(-0.5F, -1.0F, -1.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, 0.0884F, 1.0242F, 0.0F, -0.7854F, 0.0F));

        PartDefinition left_r1 = OuterSpikes.addOrReplaceChild("left_r1", CubeListBuilder.create().texOffs(21, 41).addBox(-1.5F, -1.0F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 0.0884F, 1.0242F, 0.0F, 0.7854F, 0.0F));

        PartDefinition top_r1 = OuterSpikes.addOrReplaceChild("top_r1", CubeListBuilder.create().texOffs(13, 38).addBox(-1.0F, -0.5F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.4116F, 1.0242F, 0.7854F, 0.0F, 0.0F));
